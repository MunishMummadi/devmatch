...
func SetupRouter(dbPool *pgxpool.Pool, clerkClient clerk.Client, githubService *services.GitHubService, geminiService *services.GeminiService, clerkService *services.ClerkService) *gin.Engine {
